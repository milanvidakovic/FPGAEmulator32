...
public class ST_S_MREGX_XX_REGY extends Instruction {
	public ST_S_MREGX_XX_REGY(short[] memory, int addr, int src, int dest) {
		super(memory, addr, src, dest);
		super.setArgument32();
		super.setAssembler("st.s [" + this.sdest + " + 0x%08x], " + this.ssrc);
	}
	@Override
